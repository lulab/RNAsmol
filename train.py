...
from dataset import *
from model_MCNN_multi_diffusion_bilinearattention import MGraphDTA,MCNN_GIN,MCNN_GAT,MCNN_GCN,MCNN_GAE
from utils import *
from log.train_logger_ppr_ban import TrainLogger
...
def main():
    ...
    modeling=[MGraphDTA,MCNN_GIN,MCNN_GAT,MCNN_GCN,MCNN_GAE][training_model]
    device = torch.device('cuda:7' if torch.cuda.is_available() else 'cpu')
    model = modeling(3, 26, embedding_size=96, filter_num=32, out_dim=2,ban_heads=2).to(device)
